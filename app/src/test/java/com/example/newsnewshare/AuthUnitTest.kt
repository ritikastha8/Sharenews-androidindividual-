...
import com.example.newsnewshare.repository.AuthRepoLoginImpl
...
class AuthUnitTest {
    ...
    private lateinit var authRepoLogin: AuthRepoLoginImpl
    ...
    fun setup() {
        ...
        authRepoLogin = AuthRepoLoginImpl(mockAuth)
    }
    @Test
    fun testLogin_Successful() {
        ...
        authRepoLogin.login(email, password, callback)
